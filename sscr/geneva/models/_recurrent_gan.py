...
def load_model(state, snapshot_path):
    ...
    state.image_encoder.load_state_dict(snapshot["image_encoder_state_dict"])
    state.condition_encoder.load_state_dict(snapshot["condition_encoder_state_dict"])
    ...
    state.sentence_encoder.load_state_dict(snapshot["sentence_encoder_state_dict"])
...
def save_model(state, path, epoch, iteration):
    ...
    snapshot["sentence_encoder_state_dict"] = state.sentence_encoder.state_dict()
    # snapshot['sentence_encoder_optimizer_state_dict'] = \
