...
def report_inception_objects_score(
    visualizer, logger, iteration, img_path, model_path, inception_dataset, dataset_name
):
    args = [
        ("--img-dir", img_path),
    ...
    io_jss, io_ap, io_ar, io_af1, io_cs, io_gs = calculate_inception_objects_accuracy(
